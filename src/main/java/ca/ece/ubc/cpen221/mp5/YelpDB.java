...
public class YelpDB implements MP5Db<Restaurant> {
     ...
     * one specified.
     *
     * @param tableName, the table to search through
    ...
    public List<Record> getRecordMatches(String tableName, Field<?> field) {
        ...
        List<Record> recordsToSearch = dataBase.get(tableNum).getRecords();
        //Otherwise, search through this tables records to find matches.
    ...
    public String kMeansClusters_json(int k) {
        ...
        // query += "\"" + s + "\"";
        //
        // query += "], \"state\": " + r.getState() + ", \"type\": " + r.getTypeClass() + ",
        // \"stars\": " +
     ...
     * @return a list of sets of restaurants, where each set in the list is
     * a cluster
     */
     ...
     *
     * @param list        contains the clusters
     * @param locations   average latitude and longitude for each cluster
     * @param restaurants is the list containing all the restaurants
     * @param changed     is a boolean to trigger the recursion
     ...
     *
     * @param records List of JSON lines, that represent the Restaurant class
     ...
     *
     * @param records List of JSON lines, that represent the User class
